...
//	echo $superamount . "<br>";
	...
	//	echo "$ref%payment" . "<br>";
		...
		if ($bilangin<>0)
		{echo "<td align='center'><input type='checkbox' name='check_listh[]' value='$ref%placeout' checked='checked' class='h$memberid'></td>";
	//	echo "$ref%placeout" . "<br>";
		}
		else
		{echo "<td align='center'><input type='checkbox' name='check_listh[]' value='$ref%payment' checked='checked' class='h$memberid'></td>";
	//	echo "$ref%payment" . "<br>";
		}
	}
