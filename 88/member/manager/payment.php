    ...
    <td>
		<table width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#FFEDC7" align="center">
          <tr bgcolor="#FFEDC7" class="text12Bold"> 
            ...
            <td width="1%" rowspan="2" align="left" nowrap class="text11">&nbsp;&nbsp;&nbsp;<input class="inputFormReadOnly" type="text" value="PAYMENT" name="trans_type" size="10" readonly="readonly">&nbsp;&nbsp;&nbsp;</td>
