...
$bilang = count($_POST['check_list']);
if ($bilang<>0) {
	for ($i=0; $i<$bilang;$i++) {
	$no = $_POST['check_list'][$i];
	...
	/*	$annoumcementsql=mysql_query("SELECT * FROM announcement ORDER BY entriesdate DESC");
		...
		{$no=$_POST[$count];
		mysql_query("DELETE FROM announcement WHERE no = '$no'");}
		echo "DELETE FROM announcement WHERE no = '$no'";
		echo "<SCRIPT language=\"JavaScript\">alert('Announcement Deleted!');</SCRIPT>";}
		break;*/
		}}
?>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0" bgcolor="#333355">
<table border="0" cellpadding="0" cellspacing="0" width="95%" align="center">
	<tr><td align="center" colspan="3"><span class="maintitle">Announcement</span></td></tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="95%" align="center" class="stats">
<tr>
    <td width="13%" class="hed" ><span class="bn13text"><b>Date</b></span></td>
    <td width="13%" class="hed"><span class="bn13text"><b>Entries By</b></span></td>
    <td class="hed"><span class="bn13text"><b>Message</b></span></td>
	<td class="hed"><span class="bn13text"><b>Action</b></span></td>
    <td width="5%" class="hed">
	<input type="checkbox" name="deleteall" value="delete" onClick="checkAll(document.announce['check_list[]'])">
	</td>
</tr>
<?php
		$annoumcementsql=mysql_query("SELECT * FROM announcement ORDER BY entriesdate DESC");
		...
		echo "<td ><span class='bn12text'>$data</span></td>";
		...
		echo "<td><span class='bn12text'>&nbsp;$data</span></td>";
		echo "<td><span class='bn12text'><a href='announcement.php?action=edit&no=$number&message=$data' target='_self'><img src='images/edit.gif' border='0' title='Edit'></span></td>";
		//echo "<td align='center'><input type='checkbox' name='check_list' value='$number'></td>";
		echo "<td align='left'><input type='checkbox' name='check_list[]' value='$number'></td>";
		echo"<tr>";}
?></form>
</table>
</body>
