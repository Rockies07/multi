...
?>
  ...
  <input type='hidden' value='<?php echo $mum; ?>'>
...
//	echo $superamount . "<br>";
	...
	if ($pm==0) {
		if ($bilangin<>0)
		{echo "<td align='center'><input type='checkbox'name='check_listp[]'  value='$ref%placeout' id='check_p_$count' class='d$memberid' onclick='check_hide_p($count)'> </td>";}
		else
		{echo "<td align='center'><input type='checkbox' name='check_listp[]' value='$ref%payment' id='check_p_$count' class='d$memberid' onclick='check_hide_p($count)'> </td>";
	//	echo "1-$ref%payment" . "<br>";
		}
	}
	else {
		if ($bilangin<>0)
		{echo "<td align='center'><input type='checkbox' name='check_listp[]'  value='$ref%placeout' id='check_p_$count' checked='checked' class='d$memberid' onclick='check_hide_p($count)'> </td>";}
		else
		{echo "<td align='center'><input type='checkbox' name='check_listp[]' value='$ref%payment' id='check_p_$count' checked='checked' class='d$memberid' onclick='check_hide_p($count)'> </td>";
	...
	if ($clr==0) {
		if ($bilangin<>0)
		{echo "<td align='center'><input type='checkbox' name='check_listh[]' value='$ref%placeout' id='check_h_$count' class='h$memberid' onclick='check_hide_h($count)'> </td>";
	//	echo "$ref%placeout" . "<br>";
		}
		else
		{echo "<td align='center'><input type='checkbox' name='check_listh[]' value='$ref%payment' id='check_h_$count' class='h$memberid' onclick='check_hide_h($count)'> </td>";
	//	echo "$ref%payment" . "<br>";
		}
	}
	else {
		if ($bilangin<>0)
		{echo "<td align='center'><input type='checkbox' name='check_listh[]' value='$ref%placeout' id='check_h_$count' checked='checked' class='h$memberid' onclick='check_hide_h($count)'></td>";
	//	echo "$ref%placeout" . "<br>";
		}
		else
		{echo "<td align='center'><input type='checkbox' name='check_listh[]' value='$ref%payment' id='check_h_$count' checked='checked' class='h$memberid' onclick='check_hide_h($count)'></td>";
	//	echo "$ref%payment" . "<br>";
		}
	}
...
$total2 = $outstanding2 + $pmdue2;
  ...
  <input name='hideme' type='hidden' value=''><input type='hidden' value='$memberidadv'>
  <input type='Submit' name='Save' value='Save' class='formButton' onClick='AjaxRefresh();'> 
  </td></tr><tr >   
<td class='hed' width='20%'><span class='bn13text'><b>Date</b></span></td>
<td class='hed' width='10%'><span class='bn13text'><b>ID</b></span></td>
...
$total2 = $outstanding2 + $pmdue2;
	...
	<tr bgcolor='#888888'><td ><span class='bn13text'>$memberidadv</span></td><td colspan='6' align='center' class='hedacheblack'><span class='bn13text'><b>$gtot $gout 	$gdue</b></span></td> <td><span class='bn13text'>D</span></td><td><span class='bn13text'>H</span></td><td>
  <input name='hideme' type='hidden' value=''>
  <input type='hidden' value='$memberidadv'>
  <input type='Submit' name='Save' value='Save' class='formButton' onClick='AjaxRefresh();'> 
  </td></tr><tr >   
<td class='hed' width='20%'><span class='bn13text'><b>Date</b></span></td>
<td class='hed' width='10%'><span class='bn13text'><b>ID</b></span></td>
