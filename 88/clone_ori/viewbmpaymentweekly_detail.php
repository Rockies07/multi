...
<table border="0" cellpadding="0" cellspacing="0" width="50%" align="center">
   ...
   <table border="1" cellpadding="0" cellspacing="0" width="50%" align="center" class="stats">
	<tr >
		...
		$sql_get_detail=mysql_query("select * from bmdatabase_payment where bmdate between '$week_start' and '$week_end' and cpyaccount='$cpyaccount' order by bmdate");
	$super_total=0;
	while($data=mysql_fetch_array($sql_get_detail)) 
	{
		...
		?>
		<tr>
		    <td class="hed"  colspan="3"><span class="bn13text">&nbsp;<b>Grand Total</b>&nbsp;</span></td>
