...
<table border="0" cellpadding="0" cellspacing="0" width="1000px" align="center">
	...
	if ($searchID<>"") {
	if ($SortBy=="memberid")
		$condition = " where a.memberid like '$searchID%' and a.clone_show='1' ";
	if ($SortBy=="managerid")
		$condition = " where a.managerid like '$searchID%' and a.clone_show='1'  ";
	if ($SortBy=="membername")
		$condition = " where a.membername like '$searchID%' and a.clone_show='1'  ";
	if ($SortBy=="ranking") {
		$rankname=mysql_query("SELECT no FROM ranking where name = '$searchID'");
		$ranky=mysql_result($rankname,0,"no");
		$condition = " where a.ranking like '$ranky%' and a.clone_show='1'  "; }
	}
	else { 
	$condition=="where a.clone_show='1' "; 
	}

	if($hidden_dragon=='')
	{
		$hidden_dragon=" where a.clone_show='1' ";
	}
	else
	{
		$hidden_dragon = $hidden_dragon." and  a.clone_show='1'";
	}
...
<table border="1" cellpadding="0" cellspacing="0" width="1000px" align="center" class="stats">
	...
	<td class="hed" ><span class="bn12text"><b>Mobile1</b></span></td>
		<td class="hed" width="70px"><span class="bn12text"><b>Last Login</b></span></td>
	<td class="hed" width="30px"><span class="bn12text"><b>Bank Account</b></span></td>
