...
echo "<td align='center'  ><span class='bn13text'>&nbsp;<b>$enum</b></span></td>";
	...
	echo "<td align='center'  ><span class='bn13text'>&nbsp;<b><a href='viewbmdaily_b.php?web=$type&month=$month&year=$year&deyt=$enum'><font color='red'>$postoneg_total</font></a></b></span></td>";
	}


$deyt=$_GET["deyt"];

if ($deyt==$enum && $_GET["type"]==$row[1]) {
