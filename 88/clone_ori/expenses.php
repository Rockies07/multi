...
mysql_query("update bmexpenses set amount='-$amt',remark='$remarks' where ref='$bmref'") or die(mysql_error());
echo "<SCRIPT language=\"JavaScript\">alert('Expenses got updated!');</SCRIPT>";
}
...
//	echo "bmref: " . $bmref . "<br>";
	...
	if ($action=='edit' && $_GET["bmref"]==$bmref)
	{
		echo "<td align='center'><span class='bn13text'><input type='text' size='15' name='remarks'  value='$remark'></span></td>";
	}
	else
	{
