...
<tr >
	...
	$bmdate=mysql_result($history,$count,"bmdate");  ///new lah
...
//	echo "<td align='center'><span class='bn13text'>$clr</span></td>";
	...
	echo "<a href='revertrecords.php?action=Return&ref=$ref&pass=$pass' target='_self'><img border='0' src='images/undo.gif' align='left' onclick=\"return confirm('Revert Records?');\"></a>
