...
$oldpasss=mysql_query("SELECT password FROM memberid WHERE memberid='$weblogin' and password='$webpassword'");
...
$savepass = $newpass1;
	...
	{
		mysql_query("update memberid set password = '$savepass' where memberid='$weblogin' and password='$webpassword'");
		echo "update table memberid set password = '$savepass' where memberid='$weblogin' and password='$webpassword'";
