...
<p align="center" class="text12RedBold">Multiple W/L Placeout Submission</p>
    ...
    <td>
		<table width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#FFEDC7" align="center">
          <tr bgcolor="#FFEDC7" class="text12Bold"> 
			...
			<input class="inputDate" id="inputDate" name="datetime" value="<?php echo date("m/d/Y"); ?>" />&nbsp;&nbsp;&nbsp;
			<!--<script>DateInput('datetime', true, 'YYYY-MM-DD')</script>--></td>
            <td width="1%" rowspan="2" align="left" nowrap class="text11">&nbsp;&nbsp;&nbsp;<input class="inputFormReadOnly" type="text" value="W/L PLACEOUT" name="trans_type" size="15" readonly="readonly">&nbsp;&nbsp;&nbsp;</td>
            <td rowspan="2" align="left" nowrap>&nbsp;&nbsp;&nbsp;Web:&nbsp;              <select name="selectAll" class="searchformfiled" onChange="javascript : selectAllType();" >
                <option value="">--Click--</option>
                <?php	$bmcodesql=mysql_query("SELECT subbmcode FROM bmcode");
            ...
            <td width="1%" align="left" nowrap>&nbsp;&nbsp;&nbsp;Total Amt :&nbsp;</td>
            <td width="1%" align="left" nowrap><input class="searchformfiled" type="text" name="TotalAmt" value="0" size="10" tabindex="-1" readonly ></td>
          ...
          <tr bgcolor="#FFEDC7" class="text12Bold">
            ...
            <td align="left" nowrap><select name="currency" class="searchformfiled" >
...
<tr bgcolor="#FFA800"> 
  ...
  <?php for ($i=1;$i<=30;$i++) { ?>
  	...
  	<td align="center"><input class="searchformfiled" tabindex="<?php echo $i; ?>" name="ID<?php echo $i; ?>" type="text" size="10" onKeyDown="if(event.keyCode==13) moveit(this);" onBlur="up(this)"></td>
	<td align="center"><select name="eTypeAcc<?php echo $i; ?>" class="searchformfiled" onKeyDown="if(event.keyCode==13) event.keyCode=9;"><option value="">--Click--</option><?php	$bmcodesql=mysql_query("SELECT subbmcode FROM bmcode");
				...
				echo "<option value='$data'>$data</option>";}
                ?></select></td>
	<td align="center"><input class="searchformfiled" tabindex="<?php echo $i+1; ?>" name="WL<?php echo $i; ?>" type="text" size="10" onChange="javascript: updateTotAmt();" onKeyDown="if(event.keyCode==13) backtoid(this);"></td>
