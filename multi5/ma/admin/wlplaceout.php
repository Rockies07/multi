...
<body bottomMargin="0" bgColor="#333355" leftMargin="0" topMargin="0" rightMargin="0">
...
<input type="hidden" name="ExtCID" value="<?php echo $memlist; ?>">
<!--<input type="hidden" name="weblogin" value="<?php echo $weblogin; ?>">-->
...
<!--            <td rowspan="2" align="right" nowrap>Date</td>-->
			...
			<div class="demo">Date: <input type="text" id="inputDate" name="datetime" value="<?php echo date("m/d/Y"); ?>" readonly="true" style="width:80px"><input type="hidden" value="W/L PLACEOUT" name="trans_type">
</div>
			<!--<input class="inputDate" id="inputDate" name="datetime" value="<?php echo date("m/d/Y"); ?>" readonly="true" /><img src="images/pikpik.gif" width="20" height="20" class="inputDate">--> 	</td>
          	<td align="left">Code:&nbsp;
          	  <select name="code" class="searchformfiled" onChange="AjaxFunction2(this.value)" >
                <option value="">--Click--</option>
                <?php	$bmcodesql=mysql_query("SELECT distinct bmcode FROM bmcode order by bmcode asc");
