...
<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
	...
	<tr>
	  ...
	  <td  align='left' ><input type='text' size='15' name='amount'  value='0' onBlur='numeric(this)'><input type='hidden' name='userid'  value='<?php echo $weblogin; ?>'><select name="currency" class="searchformfiled" >
	  ...
	  <td  align='left'><select name="account" class="searchformfiled" tabindex="2">
        ...
        <?php	//$bmcodesql=mysql_query("SELECT cpyaccount FROM cpyaccount where managerid='$weblogin'");
				$bmcodesql=mysql_query("SELECT cpyaccount FROM cpyaccount");
