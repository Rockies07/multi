...
a.bmdate,a.amount,a.memberid from bmdatabase_wlplaceout a where a.clr='1' and bmdate>='$enum_from' and bmdate<='$enum_to'");
		...
		echo "select (select b.bmcode from bmcode b where b.subbmcode=a.subbmcode) as bmcode,a.subbmcode,
a.bmdate,a.amount,a.memberid from bmdatabase_wlplaceout a where a.clr='1' and bmdate>='$enum_from' and bmdate<='$enum_to'";
		while ($row_mem = mysql_fetch_array($listall)) 
			...
			echo "<font color='white'>update backup_plan set amount=amount+'$amount' where bmcode='$bmcode' and subbmcode='$subbmcode' and bmdate='$bmdate' and memberid='$memberid'</font><br>";
}	
			else {
			//insert
			mysql_query("insert into backup_plan values ('$bmcode','$subbmcode','$bmdate','$amount','$memberid')");
			echo "<font color='white'>insert into backup_plan values ('$bmcode','$subbmcode','$bmdate','$amount','$memberid')</font><br>";
}
			}
	}
