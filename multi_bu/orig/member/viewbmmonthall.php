...
$getvalues=mysql_query("select sum(amount),subbmcode from bmdatabase_wlplaceout where bmdate='$enum' and entriesby='$weblogin' group by
...
echo "<td align='center' style='border:solid 1px #000000' ><span class='bn13text'>&nbsp;<b>$row[1]</b></span></td>";
	if ($row[0]<0) { $negtopos_total = number_format(abs($row[0]),2);
	echo "<td align='center' style='border:solid 1px #000000' ><span class='bn13text'>&nbsp;<b><a href='viewbmmonthall.php?code=$code&web=$type&month=$month&year=$year&type=$row[1]&bmdate=$enum&action=star'>$negtopos_total</a></b></span></td>";
	} else { $postoneg_total = number_format((0-$row[0]),2);
	echo "<td align='center' style='border:solid 1px #000000' ><span class='bn13text'>&nbsp;<b><a href='viewbmmonthall.php?code=$code&web=$type&month=$month&year=$year&type=$row[1]&bmdate=$enum&action=star'><font color='red'>$postoneg_total</font></a></b></span></td></tr>";
/*	$code=$_GET["code"];
$type=$_GET["web"];
$month=$_GET["month"];*/
	}
	...
	echo "<tr><td align='center' style='border:solid 1px #000000' bgcolor='#888888'><span class='bn13text'>&nbsp;<b>Member</b></span></td>";
	echo "<td align='center' style='border:solid 1px #000000' bgcolor='#888888' ><span class='bn13text'>&nbsp;<b>Amount</b></span></td>";
	echo "<td align='center' style='border:solid 1px #000000' bgcolor='#888888' ><span class='bn13text'>&nbsp;<b>Remark</b></span></td>";
	echo "<td align='center' style='border:solid 1px #000000' bgcolor='#888888' ><span class='bn13text'>&nbsp;<b>Action</b></span></td></tr>";
...
//	echo "select memberid,amount,remark from bmdatabase_wlplaceout where bmdate='$deyt' and subbmcode='$subbmcode' order by entriesdate asc" . "<br>";
	...
	echo "<tr><td align='center' style='border:solid 1px #000000' ><span class='bn13text'>&nbsp;<b>$row_enum[0]</b></span></td>";
	$ref=$_GET["ref"];
	//echo "<td align='center' style='border:solid 1px #000000' ><span class='bn13text'>&nbsp;<b>$row_enum[2]</b></span></td></tr>";
//	echo "<td align='center' style='border:solid 1px #000000' ><span class='bn13text'>&nbsp;<b>$row_enum[2]</b></span></td></tr>";
//if($action=='edit' && $ref==$getref){
//echo "row_enum[3]: " . $row_enum[3] . "==" . "ref: " . $ref . "<br>";
 if(($action=='edit')&&($row_enum[3]==$ref)){
	echo "<td align='center' style='border:solid 1px #000000'><input type='text' id='eamount' name='eamount' size='8' maxlength='10' value='$row_enum[1]'></td>";
	echo "<td align='center' style='border:solid 1px #000000'><input type='text' id='remark' name='remark' size='20' maxlength='20' value='$row_enum[2]'>
	<input type='hidden' id='refy' name='refy' value='$row_enum[3]'>
	</td>";
	
	}
	else {	
	echo "<td align='center' style='border:solid 1px #000000' ><span class='bn13text'>&nbsp;<b>$row_enum[1]</b></span></td>";
	echo "<td align='center' style='border:solid 1px #000000' ><span class='bn13text'>&nbsp;<b>$row_enum[2]</b></span></td>";
	/*if ($amount<0)
		 echo "<td align='center' style='border:solid 1px #000000;' ><span class='bn13text'>&nbsp;<b><font color='red'>$amount</font></b>&nbsp;</span></td>";
		 else
...
//	echo "2row_enum[3]: " . $row_enum[3] . "==" . "ref: " . $ref . "<br>";
	 if(($action=='edit')&&($row_enum[3]==$ref)){echo "<td align='center'><a href='viewbmmonthall.php?code=$code&web=$type&month=$month&year=$year&type=$row[1]&bmdate=$enum&ref=$row_enum[3]' target='_self'><img src='images/undo.gif' border='0' title='Undo'></a>&nbsp;&nbsp;
		   ...
		   echo "<td align='center' style='border:solid 1px #000000'><a href='viewbmmonthall.php?code=$code&web=$type&month=$month&year=$year&type=$row[1]&bmdate=$enum&action=edit&ref=$row_enum[3]' target='_self'><img src='images/edit.gif' border='0' title='Edit'></a></td>"; }
	echo "</form>";
	}
	echo "</table><td></tr>";
	}
...
echo "<tr><td colspan='2'></td><td align='center' style='border:solid 1px #000000' ><span class='bn13text'>&nbsp;<b>$negtopos_total</b></span></td></tr>";
} else { $postoneg_total = number_format((0-$last_total),2);
echo "<tr><td colspan='2'></td><td align='center' style='border:solid 1px #000000' ><span class='bn13text'>&nbsp;<b><font color='red'>$postoneg_total</font></b></span></td></tr>";
}
	?>
</table>
