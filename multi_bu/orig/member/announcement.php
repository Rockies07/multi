...
<tr >
    <td align="center" width="13%" style="border:solid 1px #000000"><span class="bn13text">&nbsp;Date&nbsp;</span></td>
    <td align="center" width="13%" style="border:solid 1px #000000"><span class="bn13text">&nbsp;Entries By&nbsp;</span></td>
    <td align="left" style="border:solid 1px #000000"><span class="bn13text">&nbsp;Message&nbsp;</span></td>
	<td align="left" style="border:solid 1px #000000"><span class="bn13text">&nbsp;&nbsp;Action</span></td>
    <td align="center" width="5%" style="border:solid 1px #000000"><input type="checkbox" name="deleteall" value="delete" onClick="Check(document.announce.check_list)"></td>
</tr>
<?php
		$annoumcementsql=mysql_query("SELECT * FROM announcement ORDER BY entriesdate DESC");
		$annoumcementrow=mysql_num_rows($annoumcementsql);
