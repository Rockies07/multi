...
//	$insert2 = "insert into bmdatabase_invoice values('','$datetime','$ID','$trans_type','$eTypeAcc','$compaccnt','$currency','$WL','$weblogin','$webdatetime','','')";
	$insert2 = "insert into bmdatabase_wlplaceout values('','$converted_datetime','$ID','$eTypeAcc','TKT','$currency','$WL','$weblogin','$webdatetime','','')";
	//echo $insert2;
		mysql_query($insert2); }
...
//	$insert2 = "insert into bmdatabase_payment values('','$datetime','$ID','$trans_type','$eTypeAcc','$compaccnt','$currency','$WL','$weblogin','$webdatetime','','')";
	$insert2 = "insert into bmdatabase_payment values('','$converted_datetime','$ID','$eTypeAcc','TRS','$currency','$WL','$weblogin','$webdatetime','','')";
		//echo $insert2;
		mysql_query($insert2); }
		}
	}	
