...
//	echo $main;
	...
	switch($action){
		...
		else
		{
			...
			//echo "SELECT memberid FROM memberid WHERE memberid='$memberid' union SELECT subid FROM submembers WHERE subid='$memberid'";
			//break;
	...
	echo"<tr><td align='center'><table bgcolor='#FFEFC6' border='0' cellpadding='0' cellspacing='0' width='100%' class='outline'><tr><td height='10'></td></tr><tr><td align='right' valign='top'><span class='bn13text'>Member ID&nbsp;</span></td><td align='center' valign='top'><span class='bn13text'>:</span></td><td align='left'><input type='text' name='memberid' size='15' maxlength='20' value='$memberid' onBlur='up(this);'>&nbsp;<select name='managerid'>";
  ...
  echo"<tr><td height='10' colspan='4'></td></tr>";
	...
	echo "<form action='viewmember.php' method='post' style='margin-bottom:0;'>";
	echo"<tr><td align='center'><table bgcolor='#FFEFC6' border='0' cellpadding='0' cellspacing='0' width='90%' align='center' class='outline'><tr><td align='right' valign='top'><span class='bn13text'>Member ID&nbsp;</span></td><td align='center' valign='top'><span class='bn13text'>:</span></td><td align='left'><input type='text' name='memberid' size='15' maxlength='20' value='$memberid' readonly='true'>&nbsp;<select name='managerid'>";
	if ($managerid<>"")
  ...
  echo"<tr><td height='10' colspan='4'></td></tr>";
	...
	if($action=='Update'){
				...
				if ($main=="")
							...
							$main = 1;
	if ($password<>"") {
	mysql_query("update memberid set membername='$name',membercontact1='$contact1',sms='$main',membercontact2='$contact2',bankaccount='$bankaccount',remarks='$remarks',managerid='$managerid',ranking='$rank',password='$password',status='$status' where memberid = '$memberid'") or die(mysql_error());
	}
	else
	{
	mysql_query("update memberid set membername='$name',membercontact1='$contact1',sms='$main',membercontact2='$contact2',bankaccount='$bankaccount',remarks='$remarks',managerid='$managerid',ranking='$rank',status='$status' where memberid = '$memberid'") or die(mysql_error());
	}
		echo "<SCRIPT language=\"JavaScript\">alert('Member Updated!');</SCRIPT>";
		$action='add';
		echo"<tr><td align='left'><a href='viewmember.php?action=add' target='_self'><img src='images/new.jpg' border='0' title='Add'></a></td><td></td><td align='right'><form action='viewmember.php' method='post' style='margin-bottom:0;'><font color='white'>Rank:</font><select name='filter' onchange='this.form.submit()'>";
...
echo "<option>ALL</option>";
		...
		//-=-=-= delete from member_total
		mysql_query("delete from member_total where memberid = '$mem'") or die(mysql_error());
...
echo "<option>ALL</option>";
	...
	?>
	<font color='white'>Mngrid</font><select name="mayneger" onchange="this.form.submit()">
<?php
if ($_POST["mayneger"]<>"")
		{
...
<table border="1" cellpadding="0" cellspacing="0" width="100%" align="center" class="stats">
	...
	<td class="hed"><span class="bn13text"><b>Password</b></span></td><td class="hed">
	<span class="bn13text"><b>Status</b></span></span></td>
	<td class="hed"><span class="bn13text"><b>Name</b></span></td>
	<td class="hed"><span class="bn13text"><b>Mobile(1)</b></span></td>
	<td class="hed"><span class="bn13text"><b>SMS</b></span></td>
	<td class="hed"><span class="bn13text"><b>Mobile(2)</b></span></td>
	<td class="hed"><span class="bn13text"><b>Bank Account</b></span></td>
	<td class="hed"><span class="bn13text"><b>Remarks</b></span></td>
	<td class="hed"><span class="bn13text"><b>Ranking</b></span></td>
	<td class="hed"><span class="bn13text"><b>MD</b></span></td>
	<td class="hed"><span class="bn13text"><b>Action</b></span></td></tr>
<?php
	$action=$_POST[action];
