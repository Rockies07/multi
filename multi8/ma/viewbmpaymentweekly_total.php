...
<table border="0" cellpadding="0" cellspacing="0" width="50%" align="center">
   ...
   <table border="1" cellpadding="0" cellspacing="0" width="50%" align="center" class="stats">
	<tr >
	    ...
	    $sql_get_detail=mysql_query("select bp.bmdate,bp.cpyaccount,bp.amount,bp.memberid,bp.currencycode,bp.remark from bmdatabase_payment bp,memberid m where bp.bmdate between '$week_start' and '$week_end' and m.memberid=bp.memberid $filter_query UNION select bp.bmdate,bp.cpyaccount,bp.amount,bp.memberid,bp.currencycode,bp.remark from bmdatabase_payment bp,submembers m where bp.bmdate between '$week_start' and '$week_end' and m.subid=bp.memberid $filter_query order by bmdate");
