                    ...
                    <table width="100%" cellSpacing="1" cellPadding="0" border="1" align="left">
                        <tr>
                            <th>							
								...
								Page&nbsp;<input maxLength="9" size="9" onKeyUp="javascript: KeyUpInPageNo(event);" class="mws-form-item wcolor" name="txtPage"> &nbsp;&nbsp;&nbsp;&nbsp
                                Big : <input maxLength="6" style="width: 50px; FONT-WEIGHT: bold; FONT-SIZE: 12px;" class="wcolor" name="TotalBig" value="0" readonly>
                                Sml : <input maxLength="6" style="width: 50px; FONT-WEIGHT: bold; FONT-SIZE: 12px;" class="wcolor" name="TotalSml" value="0" readonly>
                                Amt : <input maxLength="6" style="width: 60px; FONT-WEIGHT: bold; FONT-SIZE: 12px;" class="wcolor" name="TotalAmt" id="TotalAmt" value="0" readonly>
<?PHP
