        ...
        <div id="mws-container" class="clearfix">
			...
			<div class="mws-panel grid_8">
				...
				<div class="mws-panel-header" style="width:1036px">
					<div class="clearfix"></div>
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<?PHP echo form_open(''); ?>
							<td><span><i class="icon-table"></i><b> P.O Report by page</b></span></td>
							<td>
								<span><i class="icon-calendar-month"></i> 
									From:
									...
									<select name="filter_sort">
										<?php 
											if($filter_sort!="")
												echo "<option value='$filter_sort'>$filter_sort</option>";
										?>
...
?>
				...
				<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable-fn mws-table" style="FONT-SIZE: 13px;">
                            <thead>
                                <tr>
<?PHP
	if(strlen($uid) <= 4)
...
?>
                                   ...
                                   <th><div align="center">SMS Charges</div></th>
                                </tr>
                            </thead>
                            <tbody>
<?PHP
						...
						foreach($downline_array as $downline_data)
						{
							...
							{
								$report_array = $this->m_accounts->getbetrecords($fromdate,$todate,$downline_data[$downline_type],$filter_sort);
							}
							else
							{
								$report_array = $this->m_accounts->getbetrecords($fromdate,$todate,$uid,$filter_sort);
							}
...
?>									
									...
									<tr>
										...
										<td><div align="center"><?PHP echo $report_data['pageref']; ?></div></td>
										...
										<td><div align="center"><?PHP echo $report_data['entrytime']; ?></div></td>
										<td><div align="center"><?PHP echo $report_data['enterby']; ?></div></td>
										<td><div align="center"><?PHP echo anchor_popup('c_pagedetails/view/'.$report_data['ref'].'/'.$report_data['drawdate'], 'Details', $attributes); ?></div></td>
