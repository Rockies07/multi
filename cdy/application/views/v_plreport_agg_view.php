									...
									<td align="center" rowspan="2" style="padding:0">
										<table class="mws-table">
											...
											<tbody>
												<tr align="center" style="border:1px solid #D8D8D8;">
													<?PHP if($downline_report_data['share_co_perc'] > 0) {?>
													<td style="padding:0"><?PHP echo number_format($downline_report_data['share_co_amt'],2,'.',','); ?></td>
													<?PHP }
													if($downline_report_data['share_mas_perc'] > 0) {?>
													<td style="padding:0"><?PHP echo number_format($downline_report_data['share_mas_amt'],2,'.',','); ?></td>
													<?PHP }
													if($downline_report_data['share_agg_perc'] > 0) {?>
													<td style="padding:0"><?PHP echo number_format($downline_report_data['share_agg_amt'],2,'.',','); ?></td>
													<?PHP } ?>
												</tr>
											</tbody>
										</table>
