		...
		<div id="mws-container" class="clearfix">
            ...
            <div class="container">
				...
				<span style="font-size:18px;"><b> Manager -> <?PHP echo $uid;?></b></span>
				<br>
                        ...
                        <table class="mws-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Payable</th>
                                    <th>Share CO</th>
									<?PHP if($report_data['share_po_perc'] > 0) {?>
                                    <th>Share PO</th>
									<?PHP }?>
                                    <th>Tax</th>
                                    <th>Nett</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center"><?PHP echo number_format($report_data['total_ticket'],2,'.',',');?></td>
                                    <td align="center"><?PHP echo number_format($report_data['total_strike'],2,'.',',');?></td>
                                    <td align="center"><?PHP echo number_format($master_payable_nett,2,'.',','); ?></td>
                                    <td align="center"><?PHP echo number_format($report_data['share_co_amt'],2,'.',',');?></td>
									<?PHP if($report_data['share_po_perc'] > 0) {?>
                                    <td align="center"><?PHP echo number_format($report_data['share_po_amt'],2,'.',',');?></td>
									<?PHP }?>
                                    <td align="center"><?PHP echo number_format($report_data['own_intake_tax'],2,'.',',');?></td>
                                    <td align="center"><?PHP echo number_format($master_nett,2,'.',','); ?></td>
                                </tr>
							 </tbody>
                            ...
                            <tbody>
                                <tr>
                                    <td align="center">P.O Ticket</td>
                                    <td align="center"><?PHP echo number_format($report_downline_total['total_po_ticket'],2,'.',',');?></td>
                                    <td align="center"><?PHP echo number_format($report_downline_total['total_strike'],2,'.',',');?></td>
									<td align="center" rowspan="2"><?PHP echo number_format($downline_payable_nett,2,'.',',');?></td>

									<td align="center" rowspan="2"><?PHP echo number_format($report_downline_total['total_share_co'],2,'.',',');?></td>
									<?PHP if($report_data['share_po_perc'] > 0) {?>
									<td align="center" rowspan="2"><?PHP echo number_format($report_downline_total['total_share_po'],2,'.',',');?></td>
									<?PHP }?>
                                    <td align="center" rowspan="2"><?PHP echo number_format($report_downline_total['total_tax'],2,'.',',');?></td>
                                    <td align="center" rowspan="2"><?PHP echo number_format($downline_nett,2,'.',',');?></td>
                                </tr>
								<tr>
                                    <td align="center">Intake</td>
                                    <td align="center"><?PHP echo number_format($report_downline_total['total_intake_ticket'],2,'.',',');?></td>
                                    <td align="center"><?PHP echo number_format($report_downline_total['total_intake_strike'],2,'.',',');?></td>
                               </tr>
                               <tr style="border:1px solid #D8D8D8;">
									<td colspan="7" align="right"><b>PlaceOut Win/Loss</b></td>
...
<?PHP
						...
						foreach($downline_report_array as $downline_report_data)
						{
							...
							{
								$downline_report_payable =(($downline_report_data['total_meb_strike'] - ($downline_report_data['total_own_strike'] + $downline_report_data['total_downline_strike'])) - $downline_report_data['total_po_ticket'] + $downline_report_data['total_intake_ticket']);
								
								$downline_report_share = $downline_report_data['share_co_amt'] + $downline_report_data['share_po_amt'];

								$downline_report_nett = $downline_report_payable + $downline_report_share - $downline_report_data['total_intake_tax'];
...
?>
                            <tbody>
                                ...
                                <tr style="border:1px solid #D8D8D8;">
									...
									<?PHP echo anchor_popup("c_profitloss/view/".$downline_report_data['mas_id']."/".$fromdate."/".$todate, $downline_report_data['mas_id']." (".$downline_report_data['name'].")",$attributes);?></td>
										...
										<table class="mws-table">
											...
											<tbody>
												<tr align="center" style="border:1px solid #D8D8D8;">
													...
													<td style="padding:0"><?PHP echo number_format($downline_report_data['share_po_amt'],2,'.',',')." (".number_format($downline_report_data['share_po_perc'],0)."%)"; ?></td>
												</tr>
											</tbody>
										</table>
									</td>
										...
										<table class="mws-table">
											...
											<tbody>
												<tr align="center" style="border:1px solid #D8D8D8;">
													...
													<td style="padding:0"><b><?PHP echo number_format($total_po_share,2,'.',','); ?></b></td>
												</tr>
											</tbody>
										</table>
									</td>
