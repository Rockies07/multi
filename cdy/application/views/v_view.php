            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_5">
                	<div class="mws-panel-header">
                    	<span><i class="icon-official"></i><b> View SMS</b></span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
										<textarea name='smsreply' cols='30' rows='15' style="font-size: 16px" maxlength="255" readonly="true"><?PHP echo $msg; ?></textarea>
