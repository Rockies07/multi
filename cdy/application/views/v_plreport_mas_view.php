		...
		<div id="mws-container" class="clearfix">
            ...
            <div class="container">
				...
				<span style="font-size:18px;"><b> Master -> <?PHP echo $uid;?></b></span>
				<br>
                        ...
                        <table class="mws-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center" rowspan="2"><?PHP echo number_format($report_data['share_co_amt'],2,'.',',');?></td>
                                    <td align="center" rowspan="2"><?PHP echo number_format($report_data['share_po_amt'],2,'.',',');?></td>
                            ...
                            <tbody>
                                <tr>
									...
									<td align="center" rowspan="2"><?PHP echo number_format($report_share_downline['share_co'],2,'.',','); ?></td>
									<td align="center" rowspan="2"><?PHP echo number_format($report_share_downline['share_po'],2,'.',','); ?></td>
									<td align="center" rowspan="2"><?PHP echo number_format($report_share_downline['share_mas'],2,'.',','); ?></td>
                               ...
                               <tr style="border:1px solid #D8D8D8;">
									<td colspan="8" align="right"><b>My P/L Nett</b></td>
                        ...
                        <table class="mws-table">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td align="center"><b><?PHP echo number_format((0- $report_share_downline['share_mas']),2,'.',','); ?></b></td>
							   </tr>
                               <tr>
									<td colspan="3" align="right"><b>Win/Lose Nett</b></td>
                                    <td align="center"><b>
									<?PHP echo number_format(($report_data['total_own_intake_ticket'] - $report_data['total_own_strike'] - $report_data['total_own_intake_tax'] - $report_share_downline['share_mas']),2,'.',','); ?></b></td>
							   </tr>
                            </tbody>
                        </table>
                    </div>
...
<?PHP
						...
						foreach($downline_report_array as $downline_report_data)
						{
							...
							{
								$downline_report_payable =(($downline_report_data['total_meb_strike'] - ($downline_report_data['total_own_strike'] + $downline_report_data['total_downline_strike'])) - $downline_report_data['total_po_ticket'] + $downline_report_data['total_intake_ticket'] - $downline_report_data['total_intake_tax']);
								
								$downline_report_share = $downline_report_data['share_co_amt'] + $downline_report_data['share_po_amt'] + $downline_report_data['share_mas_amt'];

								$downline_report_nett = $downline_report_payable + $downline_report_share;



								$total_po_ticket = $total_po_ticket + $downline_report_data['total_po_ticket'];
								$total_in_ticket = $total_in_ticket + $downline_report_data['total_intake_ticket'];
								$total_po_strike = $total_po_strike + $downline_report_data['total_meb_strike'];
								$total_in_strike = $total_in_strike + ($downline_report_data['total_own_strike'] + $downline_report_data['total_downline_strike']);
								...
								$total_po_share = $total_po_share + $downline_report_data['share_po_amt'];
								$total_it_share = $total_it_share + $downline_report_data['share_mas_amt'];

								$total_report_tax = $total_report_tax + $downline_report_data['total_intake_tax'];
...
?>
                            <tbody>
                                ...
                                <tr style="border:1px solid #D8D8D8;">
									...
									<?PHP echo anchor_popup("c_profitloss/view/".$downline_report_data['agg_id']."/".$fromdate."/".$todate, $downline_report_data['agg_id']." (".$downline_report_data['name'].")",$attributes);?></td>
                                    ...
                                    <td align="center" rowspan="2" style="padding:0"><?PHP echo number_format((0 -$downline_report_data['total_intake_tax']),2,'.',','); ?></td>
                                    ...
                                    <td align="center" rowspan="2" style="padding:0"><?PHP echo number_format($downline_report_data['share_co_amt'],2,'.',',');?> </td>
                                    <td align="center" rowspan="2" style="padding:0"><?PHP echo number_format($downline_report_data['share_po_amt'],2,'.',','); ?> </td>
                                    <td align="center" rowspan="2" style="padding:0"><?PHP echo number_format($downline_report_data['share_mas_amt'],2,'.',','); ?> </td>
                                ...
                                <tr style="border:1px solid #D8D8D8;">
                                    ...
                                    <td align="center" style="padding:0"><?PHP echo number_format($downline_report_data['total_intake_ticket'],2,'.',','); ?></td>
                                    <td align="center" style="padding:0"><?PHP echo number_format(($downline_report_data['total_own_strike'] + $downline_report_data['total_downline_strike']),2,'.',','); ?></td>
                                </tr>
                            </tbody>
...
?>
                            <tbody>
								<tr style="border:1px solid #D8D8D8;">
                                    ...
                                    <td align="center" rowspan="2" style="padding:0"><?PHP echo number_format($total_co_share,2,'.',','); ?> </td>
                                    <td align="center" rowspan="2" style="padding:0"><?PHP echo number_format($total_po_share,2,'.',','); ?> </td>
                                    <td align="center" rowspan="2" style="padding:0"><?PHP echo number_format($total_it_share,2,'.',','); ?> </td>
