...
<div style="float:left" > <!--This is the first division of left-->
  <div id="firstpane" class="menu_list"> <!--Code for menu starts here-->
		 <p class="menu_head"><a href="intro.php" target='main' style="text-decoration:none;">Home</a></p>
		<p class="menu_head">Data Entry</p>
		<div class="menu_body">
		<a href="wlplaceout.php" target='main'>Invoice</a>
		 ...
		 <a href="viewallmemberb.php?reset=1" target='main'>Report</a>	
		</div>
		<p class="menu_head">User Management</p>
		<div class="menu_body">
			<!--<a href="viewmanager.php" target='main'>View Manager</a>-->
         <a href="viewmember.php" target='main'>View ID</a>
         <a href="viewsubmember.php" target='main'> View Sub ID</a>	
		</div>
	...
	<!--	<p class="menu_head">Administration</p>
	   ...
	   <p class="menu_head">Reports</p>
		<div class="menu_body">
          ...
          <a href="viewbmyear_cash.php" target='main'>View Cash Yearly</a>
		  <a href="viewexpyear.php" target='main'>Yearly Expenses</a>
		  <a href="member_summary.php" target='main'>Summary</a>
        </div>
