...
<div class="mws-panel grid_8">
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-magic"></i><b> Add Manager</b></span>
                    </div>
...
?>
							...
							<font color="red" size="4"><?php echo validation_errors(); ?></font>
								...
								?>
									<input type="text" maxlength="3" style="width: 45px; FONT-WEIGHT: bold;" name="man_id" value="<?php echo set_value('man_id'); ?>"> 
                                    </div>
                                </div>
								...
								<div class="mws-form-row">
                                    <label class="mws-form-label"><b>Prefix </b><span class="required">* a-z 0-9</span></label>
                                    <div class="mws-form-item">
                                        <input type="text" maxlength="1" style="width: 25px; FONT-WEIGHT: bold;" name="prefix" value="<?php echo set_value('prefix',''); ?>"> <b></b>
                                    </div>
                                </div>
