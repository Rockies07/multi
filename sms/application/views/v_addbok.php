...
<div class="mws-panel grid_8">
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-magic"></i><b> Add Bookie</b></span>
                    </div>
...
?>
							...
							<font color="red" size="4"><?php echo validation_errors(); ?></font>
                                ...
                                <div id class="mws-form-row">
									...
									<input type="text" maxlength="2" style="width: 45px; FONT-WEIGHT: bold;" name="bok_id" value="<?php echo set_value('bok_id'); ?>"> 
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                 ...
                                 <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" maxlength="4" style="width: 50px; FONT-WEIGHT: bold;" name="placeout_com" value="<?php echo set_value('placeout_com'); ?>"> <b>%</b>
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" maxlength="4" style="width: 50px; FONT-WEIGHT: bold;" name="piority" value="<?php echo set_value('piority','0'); ?>">
                                    </div>
                                </div>
                                <div class="mws-form-row">
