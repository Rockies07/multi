  ...
  <?PHP
		...
		switch(strlen($uid))
		{
			case 3: echo '<span style="font-size:18px;"><b> Manager -> '.$uid.'</b></span>';
					break;
			
			case 2: echo '<span style="font-size:18px;"><b> Master -> '.$uid.'</b></span>';
					break;
			
			case 4: echo '<span style="font-size:18px;"><b> Group -> '.$uid.'</b></span>';
					break;
			
			case 6: echo '<span style="font-size:18px;"><b> Agent -> '.$uid.'</b></span>';
					break;
			
			case 8: echo '<span style="font-size:18px;"><b> Member -> '.$uid.'</b></span>';
					break;
		}
?>             
