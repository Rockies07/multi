	...
	{      
        ...
        <div id="mws-container" class="clearfix">
			...
			<div class="mws-stat-container">
                    <!-- Statistic Item -->
                	<a class="mws-stat" style="border:3px solid red" href="<?PHP echo site_url('c_usermgt/view/manager/'); ?>">
            	...
            	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table mws-datatable"  style="FONT-SIZE: 13px;">
                            <thead>
								<td align="center"><b>Master ID</b></td>
								<td align="center"><b>Name</b></td>
								<td align="center"><b>Password</b></td>
								<td align="center"><b>Comm</b></td>
								<td align="center"><b>Share PO</b></td>
								<td align="center"><b>Share CO</b></td>
...
?>
                                <tr>
								<td align="center"><?PHP echo $member_data['man_id']; ?></td>
								...
								<td align="center"><?PHP echo $member_data['share_po']; ?> %</td>
								<td align="center"><?PHP echo $member_data['share_co']; ?> %</td>
								<td align="center"><?PHP echo $member_data['intake_tax']; ?></td>
								<td align="center"><?PHP echo $member_data['status']; ?></td>
								<td align="center"><?PHP echo anchor_popup('c_usermgt/edit/manager/'.$member_data['man_id'], 'Edit', $attributes); ?></td>
								</tr>
<?PHP
	}
?>
