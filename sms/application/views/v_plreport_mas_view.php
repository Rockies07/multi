										...
										<table class="mws-table">
											...
											<tbody>
												<tr align="center" style="border:1px solid #D8D8D8;">
													...
													<?PHP }
													if($report_data['share_po_perc'] > 0) {?>
													<td style="padding:0"><?PHP echo number_format($report_share_downline['share_po'],2,'.',','); ?></td>
													<?PHP }
													if($report_share_downline['share_mas'] != 0) {?>
                                ...
                                <tr style="border:1px solid #D8D8D8;">
									...
									<td align="center" rowspan="2" style="padding:0">
										<table class="mws-table">
											<thead>
												<tr align="center">
													<?PHP if($downline_report_data['share_co_amt'] != 0) {?>
													<th>CO</th>
													<?PHP }
													if($downline_report_data['share_po_amt'] != 0) {?>
													<th>PO</th>
													<?PHP }
													if($downline_report_data['share_mas_amt'] != 0) {?>
													<th>IT</th>
													<?PHP } ?>
												</tr>
											</thead>
											<tbody>
												<tr align="center" style="border:1px solid #D8D8D8;">
													<?PHP if($downline_report_data['share_co_amt'] != 0) {?>
													<td style="padding:0"><?PHP echo number_format($downline_report_data['share_co_amt'],2,'.',',')." (".number_format(($downline_report_data['share_co_perc'] / $drawcount),0)."%)"; ?></td>
													<?PHP }
													if($downline_report_data['share_po_amt'] != 0) {?>
													<td style="padding:0"><?PHP echo number_format($downline_report_data['share_po_amt'],2,'.',',')." (".number_format(($downline_report_data['share_po_perc'] / $drawcount),0)."%)"; ?></td>
													<?PHP }
													if($downline_report_data['share_mas_amt'] != 0) {?>
													<td style="padding:0"><?PHP echo number_format($downline_report_data['share_mas_amt'],2,'.',',')." (".number_format(($downline_report_data['share_mas_perc'] / $drawcount),0)."%)"; ?></td>
													<?PHP } ?>
												</tr>
											</tbody>
										</table>
										...
										<table class="mws-table">
											...
											<tbody>
												<tr align="center" style="border:1px solid #D8D8D8;">
													...
													<?PHP }
													if($total_it_share != 0) {?>
													<td style="padding:0"><b><?PHP echo number_format($total_it_share,2,'.',','); ?></b></td>
													<?PHP } ?>
												</tr>
											</tbody>
										</table>
