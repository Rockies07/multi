...
?>
						...
						?>
                                <div id class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <?php echo form_dropdown('agg_id', $downlinedata , '#' ,$select_attributes); ?> 
                                    </div>
                                </div>
						<?PHP
							}
						?> 
								...
								?>
                                        <input type="text" maxlength="2" style="width: 45px; FONT-WEIGHT: bold;" name="agt_id" value="<?php echo set_value('agt_id'); ?>"> 
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" maxlength="4" style="width: 50px; FONT-WEIGHT: bold;" name="shareagg" value="<?php echo set_value('shareagg','0'); ?>"> <b>%</b>
                                    </div>
                                </div>
								<hr>
                                <div class="mws-form-row">
