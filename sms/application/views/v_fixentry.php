...
// <![CDATA[
	...
	{      
		...
		{     
			...
			{
                type: "POST",
                url: "<?PHP echo site_url('/c_entryfix/getfixpagedata/"+meb_id+"/"+meb_page+"'); ?>", 
                dataType : "json",
		...
		{     
			...
			$.ajax({
			  type: "POST", //or GET
			  url: "<?PHP echo site_url('/c_entryfix/delfixpagedata/"+meb_id+"/"+meb_page+"'); ?>", 
			  data: '',
			...
			<tr>	
				<td colspan="4" style="align:center;">
                      ...
                      <table align="center">
                        ...
                        <tr>
							<td><button type="button" class="btn" value="Delete" id="delete">Delete Page</button></td>
