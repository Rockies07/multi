...
<div class="mws-panel grid_8">
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-magic"></i><b> Add Agent</b></span>
                    </div>
...
?>
							...
							<font color="red" size="4"><?php echo validation_errors(); ?></font>
                                ...
                                <div id class="mws-form-row">
                                    <label class="mws-form-label"><b>Agent ID </b><span class="required">*</span></label>
                                    <div class="mws-form-item">
                                        <input type="text" maxlength="6" style="width: 70px; FONT-WEIGHT: bold;" name="agt_id" value="<?php echo $uid_data['agt_id']; ?>" readonly> 
                                    </div>
                                </div>
								...
								<hr>
                                <legend class="wizard-label"><i class="icol-doc-resize-actual"></i><b> Setting</b></legend>
                                <div class="mws-form-row">
                                    <label class="mws-form-label"><b>Share Company</b><span class="required">*</span></label> 
                                    <div class="mws-form-item">
                                        <input type="text" maxlength="4" style="width: 50px; FONT-WEIGHT: bold;" name="shareco" value="<?php echo set_value('shareco',$uid_data['share_co']); ?>"> <b>%</b>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label"><b>Share Master Intake</b><span class="required">*</span></label> 
                                    <div class="mws-form-item">
                                        <input type="text" maxlength="4" style="width: 50px; FONT-WEIGHT: bold;" name="sharemas" value="<?php echo set_value('sharemas',$uid_data['share_mas']); ?>"> <b>%</b>
                                    </div>
                                </div>

                                <div class="mws-form-row">
                                    <label class="mws-form-label"><b>Share Group Intake</b><span class="required">*</span></label>
                                    <div class="mws-form-item">
                                        <input type="text" maxlength="4" style="width: 50px; FONT-WEIGHT: bold;" name="shareagg" value="<?php echo set_value('shareagg',$uid_data['share_agg']); ?>"> <b>%</b>
                                    </div>
                                </div>
								<hr>
                                <div class="mws-form-row">
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" maxlength="4" style="width: 50px; FONT-WEIGHT: bold;" name="intake_big" value="<?php echo set_value('intake_big',$uid_data['intake_big']); ?>"> 
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label"><b>Intake Small </b><span class="required">*</span></label>
                                    <div class="mws-form-item">
                                        <input type="text" maxlength="4" style="width: 50px; FONT-WEIGHT: bold;" name="intake_small" value="<?php echo set_value('intake_small',$uid_data['intake_small']); ?>"> 
                                    </div>
                                </div>
								<div class="mws-form-row">
