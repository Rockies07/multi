...
<div class="mws-panel grid_8">
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-magic"></i><b> Edit Group</b></span>
                    </div>
...
?>
							...
							<font color="red" size="4"><?php echo validation_errors(); ?></font>
                                ...
                                <div id class="mws-form-row">
									...
									<input type="text" maxlength="2" style="width: 60px; FONT-WEIGHT: bold;" name="agg_id" value="<?php echo $uid_data['agg_id']; ?>" readonly> 
                                    </div>
                                </div>
                                ...
                                <legend class="wizard-label"><i class="icol-doc-resize-actual"></i><b> Settings</b></legend>
                                 <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" maxlength="4" style="width: 50px; FONT-WEIGHT: bold;" name="sharepo" value="<?php echo set_value('sharepo',$uid_data['share_po']); ?>"> <b>%</b>
                                    </div>
                                </div>
