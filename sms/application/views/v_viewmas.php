...
<div class="mws-panel grid_8">
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-magic"></i><b> Edit Master</b></span>
                    </div>
...
?>
							...
							<font color="red" size="4"><?php echo validation_errors(); ?></font>
                                ...
                                <div id class="mws-form-row">
                                    <label class="mws-form-label"><b>Master ID </b><span class="required">*</span></label>
                                    <div class="mws-form-item">
									<input type="text" maxlength="2" style="width: 60px; FONT-WEIGHT: bold;" name="agg_id" value="<?php echo $uid_data['mas_id']; ?>" readonly> 
                                    </div>
                                </div>
