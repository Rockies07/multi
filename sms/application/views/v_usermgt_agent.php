...
?>
                	<a class="mws-stat" style="border:3px solid red" href="<?PHP echo site_url('c_usermgt/view/agent/'.$uid); ?>">
                    	<!-- Statistic Icon (edit to change icon) -->
                    	<span class="mws-stat-icon icol32-building"></span>
...
?>
                                <tr>
								<td align="center"><?PHP echo anchor('c_usermgt/view/member/'.$member_data['agt_id'], $member_data['agt_id']); ?></td>
								...
								<td align="center"><?PHP echo anchor_popup('c_usermgt/edit/agent/'.$member_data['agt_id'], 'Edit', $attributes); ?></td>
								</tr>
<?PHP
	}
?>
