...
$month = "0" . $month;
	...
	$bmsql=mysql_query("SELECT * FROM bmdatabase_payment where MONTH(bmdate)='$month' and YEAR(bmdate)='$year'");
...
echo "<td align='center'><span class='bn13text'><b><font color='blue'>$bmamount</</b></span></td>";
