...
/*	echo "<td align='center'><span class='bn13text'>$type</span></td>";
	...
	//echo "Select bmcode from bmcode where bmcode like 'FIX'";
 	//echo $bilangin . "<br>";
//	echo $atsign . "<br>";
	if ($atsign!="")
...
<td class='hed'  width='5%'>
	<span class='bn13text'><b><input type='checkbox' id='d$memberidadv' onClick=\"check_all(this.id,'d$memberidadv')\"></b></span>
</td> <td class='hed'  width='5%'>
	<span class='bn13text'><b><input type='checkbox' id='h$memberidadv' onClick=\"check_all(this.id,'h$memberidadv')\"></b></span>
...
//		}
	...
	$sql_get_subs=mysql_query("SELECT * from submembers WHERE memberid='$get_member_id' having subid not in ($member_shown)");
