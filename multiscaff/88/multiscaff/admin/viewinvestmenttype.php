		...
		//	if(($projcode)&&($subcode)&&($bmname))
			if(($projcode))
				...
				$projcodesqlrow=mysql_num_rows($projcodesql);
					...
					else{mysql_query("INSERT INTO projects (no, projcode, description, status) VALUES('','$projcode','$description','$datetime')")or die(mysql_error());
...
<table border="0" cellpadding="0" cellspacing="0" width="50%" align="center">
	<tr>
	  <td align="center"><span class="maintitle">View Projects <br>
	      <br>
<?php echo "1. Max 8 alphanumeric characters<br>2. Project Code cannot be deleted.<br>3. You cannot rename the Project Code<br>"; ?>
	...
	echo"<tr><td align='right'><span class='bn13text'>Project Code</span></td><td width='15' align='center'><span class='bn13text'></span></td><td align='left'><input type='text' maxlength='15' size='15' name='projcode' value='$projcode'></td></tr>
	<tr><td align='right'><span class='bn13text'>Description</span></td><td width='15' align='center'><span class='bn13text'></span></td><td align='left'><input type='text' maxlength='30' size='30' name='description' value='$description'></td></tr>	
	";
...
<table cellpadding="0" cellspacing="0" width="40%" align="center" class="stats">
<tr>
	...
	<td align="center" class="hed"><span class="bn13text">&nbsp;<b>Description</b>&nbsp;</span></td>
</tr>
    <?php
	...
	$data=mysql_result($bmsql,$count,"description");
	echo "<td align='center'><span class='bn13text'>$data</span></td>";
	echo "</form></td></tr>";}
	?>
