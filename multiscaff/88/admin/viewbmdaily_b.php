...
//echo "select ifnull(sum(amount),0)+(select sum(amount from backup_plan where bmdate='$enum' and subbmcode='$type') from bmdatabase_wlplaceout where bmdate='$enum' and subbmcode='$type' order by entriesdate asc" . "<br><br>";
