<?php
	...
	$bmcodesql=mysql_query("select subbmcode as bmcode from bmdatabase_wlplaceout where year(bmdate)='$get_year' group by subbmcode having subbmcode in (select bmcode from bmcode) order by subbmcode");
