...
$oldpasss=mysql_query("SELECT password FROM adminid WHERE adminid='$weblogin' and password='$webpassword'");
...
$savepass = $newpass1;
	...
	{
		mysql_query("update adminid set password = '$savepass' where adminid='$weblogin' and password='$webpassword'");
		echo "update table adminid set password = '$savepass' where adminid='$weblogin' and password='$webpassword'";
...
function ValidateForm(thisform)
{
		...
		//alert('<?php echo $oldpassy; ?>');
		if (thisform.oldpass.value!='<?php echo $oldpassy; ?>') {
