...
<link href="<?php echo base_url();?>public/css/timeline-old.css" rel="stylesheet" type="text/css"/>
<!-- END PAGE LEVEL STYLES -->
<!-- BEGIN THEME STYLES -->
<link href="<?php echo base_url();?>public/css/components-rounded.css" id="style_components" rel="stylesheet" type="text/css">
						...
						<ul class="timeline">
							<li class="timeline-yellow">
								...
								<div class="timeline-body">
									...
									<div class="timeline-content">
										<img class="timeline-img pull-left" src="<?php echo base_url();?>public/theme/timeline/assets/admin/pages/media/blog/2.jpg" alt="">
							...
							<li class="timeline-blue">
								...
								<div class="timeline-body">
									...
									<div class="timeline-content">
										<img class="timeline-img pull-right" src="<?php echo base_url();?>public/theme/timeline/assets/admin/pages/media/blog/1.jpg" alt="">
							...
							<li class="timeline-green">
								...
								<div class="timeline-body">
									...
									<div class="timeline-content">
										<img class="timeline-img pull-left" src="<?php echo base_url();?>public/theme/timeline/assets/admin/pages/media/blog/3.jpg" alt="">
								...
								<div class="timeline-body">
									...
									<div class="timeline-content">
										<div class="scroller" data-height="175px" data-always-visible="1" data-rail-visible1="1">
											<p>
												<img class="timeline-img pull-right" src="<?php echo base_url();?>public/theme/timeline/assets/admin/pages/media/blog/4.jpg" alt="">
											...
											<p>
												<img class="timeline-img pull-left" src="<?php echo base_url();?>public/theme/timeline/assets/admin/pages/media/blog/6.jpg" alt=""> Caulie dandelion maize lentil collard greens radish arugula sweet pepper water spinach kombu courgette lettuce. Celery coriander bitterleaf epazote radicchio shallot winter purslane collard greens spring onion squash lentil. Artichoke salad bamboo shoot black-eyed pea brussels sprout garlic kohlrabi radicchio shallot winter purslane collard greens spring onion squash lentil.
											</p>
											<p>
												 Coriander bitterleaf epazote radicchio shallot winter purslane collard. Caulie dandelion maize lentil collard greens radish arugula sweet pepper water spinach kombu courgette lettuce. Celery coriander bitterleaf epazote radicchio shallot winter purslane collard greens spring onion squash lentil. Artichoke salad bamboo shoot black-eyed pea brussels sprout garlic kohlrabi.
											</p>
							...
							<li class="timeline-red">
								...
								<div class="timeline-body">
									<h2>Daily Feeds</h2>
									<div class="timeline-content">
										<img class="timeline-img pull-left" src="<?php echo base_url();?>public/theme/timeline/assets/admin/pages/media/blog/5.jpg" alt="">
