...
<div id="content">
	<ul class="breadcrumb">
		...
		<li class="divider"></li>
		<li>Inventory Requisition</li>
	</ul>
	<div class="separator bottom"></div>
	<div class="validation_wrapper center">
		<?php echo validation_errors(); ?>
	</div>
	<h3 class="glyphicons table"><i></i>Inventory Requisition</h3>
						...
						<div class="span12">
							...
							<div class="span6">
								<select class="selectpicker span12" name="site" id="site" data-live-search="true" >
									<?php 
										if(isset($edit_transaction_inventory->site_id))
										{
											
									?>
											<option value="<?php echo $edit_transaction_inventory->site_id;?>"><?php echo $edit_transaction_inventory->name;?></option>
									<?php 
										}
										else
										{
									?>	
											<option value="0">General Inventory Requisition</option>
									<?php
										}
									?>
									<?php
								...
								<input type="hidden" name="edit_id" value="<?php echo (isset($edit_transaction_inventory->id))?$edit_transaction_inventory->id:'0';?>"/>
							</div>
							<div class="span5">
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td class="center" style="vertical-align:middle">
												<input type="text" name="date_<?php echo $i;?>" id="date_<?php echo $i;?>" class="input-mini datepicker" value="<?php echo date('m/d/Y');?>" style="width: 80px;" />
											</td>
											...
											<td style="vertical-align:middle">
												<select data-live-search="true" class="selectpicker" name="ledger_<?php echo $i;?>" id="ledger_<?php echo $i;?>">
													<option value="">-Select-</option>
													<?php
...
<script type="text/javascript">
	...
	function reload(){
		window.location.href = '<?PHP echo site_url("transaction_inventory/add_expenses"); ?>';
	}
	...
	function validate()
	{
		...
		if(site!="")
		{
			...
			{
				alert("No Inventory Requisition Data Inserted. Date, Amount, Account and Ledger cannot be blank..");
				return false;
			}
		}
		else
