							...
							<tbody>
								...
								?>
										<tr class="gradeX">
											...
											-->
											<td style="vertical-align:middle" class="center">
												<input type="text" id="work_hour_<?php echo $transaction_employee_item["id"];?>" class="right edit_text" style="width:50px" maxlength="6" value="<?php echo $transaction_employee_item['work_hour'];?>" onkeypress="return isNumberKey(event)" readonly/>
												<div class="hidden_element"><?php echo $transaction_employee_item['work_hour'];?></div>
											</td>
											<td style="vertical-align:middle" class="center">
												<input type="text" id="ot_hour_<?php echo $transaction_employee_item["id"];?>" class="right edit_text" style="width:50px" maxlength="6" value="<?php echo $transaction_employee_item['ot_hour'];?>" onkeypress="return isNumberKey(event)" readonly/>
												<div class="hidden_element"><?php echo $transaction_employee_item['ot_hour'];?></div>
											</td>
											<td style="vertical-align:middle" class="right">
												<input id="normal_salary_<?php echo $transaction_employee_item["id"];?>" value="$<?php echo number_format($transaction_employee_item["normal_salary"],2);?>" class="right hidden_text" style="width:80px" readonly>
												<div class="hidden_element"><?php echo $transaction_employee_item['normal_salary'];?></div>
											</td>
											<td style="vertical-align:middle" class="right">
												<input id="ot_salary_<?php echo $transaction_employee_item["id"];?>" value="$<?php echo number_format($transaction_employee_item["ot_salary"],2);?>" class="right hidden_text" style="width:80px" readonly>
												<div class="hidden_element"><?php echo $transaction_employee_item['ot_salary'];?></div>
											</td>
											<td style="vertical-align:middle" class="right">
												<input id="meal_fee_<?php echo $transaction_employee_item["id"];?>" value="$<?php echo number_format($transaction_employee_item["meal_fee"],2);?>" class="right hidden_text" style="width:50px" readonly>
												<div class="hidden_element"><?php echo $transaction_employee_item['meal_fee'];?></div>
											</td>
											<td style="vertical-align:middle" class="right">
												<div class="normal_session">
													<input id="ns_fee_<?php echo $transaction_employee_item["id"];?>" value="$<?php echo number_format($transaction_employee_item["ns_fee"],2);?>" class="right hidden_text" style="width:50px" readonly>
													<div class="hidden_element"><?php echo $transaction_employee_item['ns_fee'];?></div>
												</div>
												<div class="edit_session">
													...
													?>
													<input type="checkbox" name="ns" id="ns_<?php echo $transaction_employee_item["id"];?>" value="1" <?php echo $ns_checked;?>>
												</div>
											</td>
											<td class="center actions" style="vertical-align:middle" >
												<a class="btn-action glyphicons pencil btn-success normal_session" onclick="edit_show_text('<?php echo $transaction_employee_item["id"];?>')"><i></i></a>
												<?php
														echo anchor('transaction_employee/delete/'.$transaction_employee_item['id'].'/management', '<i></i>',array('class' => 'btn-action glyphicons remove_2 btn-danger normal_session','onclick'=>"return confirm('Are you sure to remove this employee data?')"));
												?>
												<a class="btn-action glyphicons ok_2 btn-primary edit_session" onclick="save_text('<?php echo $transaction_employee_item["id"];?>')"><i></i></a>
												<a class="btn-action glyphicons repeat btn-danger edit_session" onclick="save_hide_text('<?php echo $transaction_employee_item["id"];?>')"><i></i></a>
											</td>
										</tr>
								<?php
									}
