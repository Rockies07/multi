...
<div id="content">
	...
	<h3 class="glyphicons table"><i></i>Man Count Summary <?php echo $position;?> (<?php echo date('d M Y',strtotime($filter_date_from));?>)</h3>
						...
						<tbody>
							...
							?>
									<tr class="gradeX">
										...
										<td class="right"><?php echo number_format($man_count_detail_item['daily_rate'],2); ?></td>
										<td class="right"><?php echo number_format($man_count_detail_item['hourly_rate'],2); ?></td>
										<td class="right"><?php echo number_format($man_count_detail_item['levy'],2); ?></td>
									</tr>
							<?php 
								}
							?>
