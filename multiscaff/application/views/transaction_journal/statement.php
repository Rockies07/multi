			        ...
			        <form>
		            	...
		            	<div class="form-group">
			          	...
			          	<div class="form-group" style="height: 66px;">
			            	...
			            	<select class="selectpicker span12" name="edit_site" id="edit_site" data-live-search="true">
								<?php
									foreach ($site as $site_item){
								?>
			          	...
			          	<div class="form-group" style="height: 66px;">
			            	...
			            	<select class="selectpicker span12 dropup" data-live-search="true" name="edit_ledger" id="edit_ledger">
			          	...
			          	<div class="form-group">
			            	...
			            	<input type="text" class="form-control" name="edit_description" id="edit_description" style="width:400px">
			          	</div>
			        </form>
		      	</div>
...
<script type="text/javascript">
 	...
 	function update_statement()
	{
		...
		if($("#edit_amount").val()!="")
		{
		    ...
		    var string_data=id+"---"+siteid+"---"+amount+"---"+date+"---"+cheque+"---"+payerpayee+"---"+ledger+"---"+project_id+"---"+gst+"---"+account+"---"+type+"---"+description;
