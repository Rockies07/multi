...
<div id="content">
	...
	<h3 class="glyphicons table"><i></i>Deposit</h3>
							...
							<div class="span6">
								<select class="selectpicker span12" name="site" id="site" data-live-search="true">
									...
									<?php 
										...
										{
									?>	
											<option value="0">General Deposit</option>
									<?php
										}
									?>
									<?php
								...
								?>
										<tr>
											...
											<td style="vertical-align:middle">
												<select class="selectpicker" data-live-search="true" name="account_<?php echo $i;?>" id="account_<?php echo $i;?>">
											...
											<td style="vertical-align:middle">
												<select class="selectpicker" data-live-search="true" name="ledger_<?php echo $i;?>" id="ledger_<?php echo $i;?>">
													<option value="">-Select-</option>
													<?php
...
<script type="text/javascript">
	...
	function reload(){
		window.location.href = '<?PHP echo site_url("transaction_journal/add_deposit"); ?>';
	}
	...
	function validate()
	{
		...
		if(site!="")
		{
			...
			{
				alert("No Expenses Data Inserted. Date, Amount, Account and Ledger cannot be blank..");
				return false;
			}
		}
		else
