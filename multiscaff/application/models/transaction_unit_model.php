<?php
class Transaction_unit_model extends CI_Model
{
	private $table_name='transaction_unit';
	...
	{
		$this->db->select('transaction_unit.id,transaction_unit.date,transaction_unit.project_id,project.name as project_name,transaction_unit.site_id,site.name as site_name,transaction_unit.amount,transaction_unit.location,employee.name as group_name');
		$this->db->from($this->table_name);
		$this->db->join('project', 'project.id = transaction_unit.project_id');
		$this->db->join('site', 'site.id = transaction_unit.site_id');
		$this->db->join('employee', 'employee.nts = transaction_unit.group');
