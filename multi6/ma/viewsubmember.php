...
if ($filter<>"" && $filter<>"ALL") {
	...
	for($count=0; $count<$memberidrow; $count++)
	  ...
	  echo "</select></td><td ><span class='bn13text'>*Sub ID&nbsp;</span></td><td ><span class='bn13text'>:</span></td><td align='left'><input type='text' name='subid' size='10' maxlength='30' onBlur='up(this)'><td align='right' ></td>";
