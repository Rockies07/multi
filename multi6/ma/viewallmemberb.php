...
<table bgcolor='#FFEFC6' border='0' cellpadding='0' cellspacing='0' width='1050px' align='center' class='outline'>
<tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="1050px" align="center">
...
$memberidsql=mysql_query("SELECT memberid FROM memberid WHERE memberid='$memberid' union SELECT subid FROM submembers WHERE subid='$memberid'");
			...
			mysql_query("INSERT INTO memberid (no, memberid, password, status, managerid, membername, membercontact1, membercontact1tick, membercontact2, membercontact2tick, bankaccount, remarks, sms, datetime, ranking, outstanding) VALUES('', UCASE('$memberid'), '$password', '1', '$managerid', '$name', '$contact1', '$membercontact1tick', '$contact2', '$membercontact2tick', '$bankaccount', '$remarks', '$main', '$datetime', '$rank','$outstanding')") or die(mysql_error());
	...
	echo "<tr><td align='right' valign='top'><span class='bn12text'>Name&nbsp;</span></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td align='left'><input type='text' name='name' size='15' maxlength='30' value='$name'>
	...
	//	if($rank!=$no){echo"<option value='$no'>$name-$no</option>";}
	  ...
	  echo "</select></span>
	<td align='right' valign='top'><span class='bn12text'>Site&nbsp;</span></td></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td align='left'><span class='bn12text'><input type='text' size='15' name='bankaccount' maxlength='50' value='$bankaccount'></span></td></tr>";
	...
	echo"</td><td align='right' valign='top'><span class='bn12text'>Remark&nbsp;</span></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td align='left'><input type='text' name='remarks' size='25' maxlength='100' value='$remarks'></td></tr>";
	echo "<tr><td align='right' valign='top'><span class='bn12text'>Mobile&nbsp;</span></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td align='left'><input type='text' name='contact2' size='15' maxlength='13' value='$contact2' onBlur='numeric(this)'></td>";
	echo"</td><td align='right' valign='top'><span class='bn12text'>Outstanding&nbsp;</span></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td align='left'><input type='text' name='outstanding' size='25' maxlength='12' value='$outstanding' onBlur='numeric(this)'></td></tr>";
  ...
  echo"<tr><td height='10' colspan='4'></td></tr>";
	...
	$memberlist=mysql_query("SELECT managerid,membername,membercontact1,bankaccount,remarks,sms,membercontact2,outstanding FROM memberid where memberid = '$memberid'");
	...
	echo "<option value='$nihao'>$nihao</option>";
	 ...
	 echo "</select></td><td align='right' valign='top'><span class='bn12text'>Password&nbsp;</span></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td align='left'><input type='password' name='password' size='15' maxlength='15'><td align='right' valign='top'></td>";
	echo "<tr><td align='right' valign='top'><span class='bn12text'>Name&nbsp;</span></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td align='left'><input type='text' name='name' size='15' maxlength='30' value='$name'><td align='right' valign='top'><span class='bn12text'>Site&nbsp;</span></td></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td align='left'><span class='bn12text'><input type='text' size='15' name='bankaccount' maxlength='50' value='$bankaccount'></span></td></tr>";
	echo "<tr><td align='right' valign='top'><span class='bn12text'>Incharge&nbsp;</span></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td align='left'><input type='text' name='contact1' size='15' maxlength='30' value='$contact1'>&nbsp;";
	if($main=='2'){echo"<span class='bn12text'>SMS<input type='checkbox' name='main' value='1' checked='checked'></span>";}
	else{echo"<span class='bn12text'><span class='bn12text'>SMS<input type='checkbox' name='main' value='2'></span>";}
	echo"</td><td align='right' valign='top'><span class='bn12text'>Remark&nbsp;</span></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td align='left'><input type='text' name='remarks' size='25' maxlength='100' value='$remarks'></td></tr>";
	echo "<tr><td align='right' valign='top'><span class='bn12text'>Mobile&nbsp;</span></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td align='left'><input type='text' name='contact2' size='15' maxlength='13' value='$contact2' onBlur='numeric(this)'></td>";
	echo "<td align='right' valign='top'><span class='bn12text'>Client Outstanding&nbsp;</span></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td align='left'><input type='text' name='outstanding' size='15' maxlength='12' value='$outstanding' onBlur='numeric(this)'></td></tr>";
	echo "<tr><td align='right' valign='top'><span class='bn12text'>SubID&nbsp;</span></td><td align='center' valign='top'><span class='bn12text'>:</span></td><td valign='top' colspan='2'><span class='bn12text'>$submemlist</span></td><td colspan='3'></td></tr>";
  ...
  echo"<tr><td height='10' colspan='4'></td></tr>";
	...
	if($action=='Update'){
	if ($password<>"") {
	mysql_query("update memberid set membername='$name',membercontact1='$contact1',sms='$main',membercontact2='$contact2',bankaccount='$bankaccount',remarks='$remarks',managerid='$managerid',password=$password, outstanding=$outstanding where memberid = '$memberid'") or die(mysql_error());
	}
	else
	{
	mysql_query("update memberid set membername='$name',membercontact1='$contact1',sms='$main',membercontact2='$contact2',bankaccount='$bankaccount',remarks='$remarks',managerid='$managerid', outstanding=$outstanding where memberid = '$memberid'") or die(mysql_error());
	}
...
<table border="1" cellpadding="0" cellspacing="0" width="1050px" align="center" class="stats">
	<tr align="center">
	...
	<td class="hed" width="100px"><span class="bn12text"><b>Incharge</b></span></td>
	<td class="hed" width="220px"><span class="bn12text"><b>Site</b></span></td>
	<td class="hed" width="150px"><span class="bn12text"><b>Remarks</b></span></td>
	<td class="hed" width="100px"><span class="bn12text"><b>Client Outstanding</b></span></td>
...
$memberidsql = "select a.memberid,a.membername,a.membercontact1,a.bankaccount,a.remarks,a.sms,a.membercontact2,a.ranking,a.status,a.managerid,a.outstanding from memberid a $hidden_dragon $condition $filthy $filtmanager ORDER BY $orderby $sort";
...
/*	if ($outstanding<=="" || $outstanding<==0.00)
	...
	if ($row_memlist[10]<0)
		echo "<td align='center' ><span style='font-family:Arial, Helvetica, sans-serif; vertical-align:middle; font-size:12px; color:red; font-weight:normal; '>".number_format($row_memlist[10],2)."</span></td>";
		else
		echo "<td align='center' ><span style='font-family:Arial, Helvetica, sans-serif; vertical-align:middle; font-size:12px; color:blue; font-weight:normal; '>".number_format($row_memlist[10],2)."</span></td>";

	$total_outstanding=$total_outstanding+$row_memlist[10];
...
<tr>
	  ...
	  <?php
		...
		echo "<font color='red'><b>" . number_format($super_outstanding,2) . "</font></b></span></td>";
	  	...
	  	if ($super_due<0)
		echo "<td align='center' class='hed'><span class='bn12text'><b><font color='red'>". number_format($super_due,2) . "</font></b></span></td>";
		else
		echo "<td align='center' class='hed'><span class='bn12text'><b><font color='blue'>". number_format($super_due,2) . "</font></b></span></td>";
	//  echo "<td align='center'><span class='bn12text'><b>$final_due</b></span></td><td colspan='7' align='center'>&nbsp;</td>";
	    ?>
	   	<td colspan="3" style='text-align:right' class="hed"><span class="bn12text"><b>Total Client Outstanding: </b></span><span class="bn12text"></span></td>
	   	<td class='hed'>
	   		<?php 
	   			if ($total_outstanding<0)
					echo "<span class='bn12text'><b><font color='red'>". number_format($total_outstanding,2) . "</font></b></span>";
					else
					echo "<span class='bn12text'><b><font color='blue'>". number_format($total_outstanding,2) . "</font></b></span>";
	   		?>
	   	</td>
