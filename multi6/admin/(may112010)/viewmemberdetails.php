...
//-=-=-=- update
	...
	//echo $datum . "<BR>";
		...
		if ($not_to_uncheck_w<>"")
	//	mysql_query("update bmdatabase_wlplaceout set pm='0' WHERE ref in ($refcol) and not ref in ($not_to_uncheck_w)");
	...
	//	mysql_query("update bmdatabase_wlplaceout set pm='0' WHERE ref in ($refcol)");
		...
		if ($not_to_uncheck_p<>"")
	//	mysql_query("update bmdatabase_payment set pm='0' WHERE ref in ($refcol) and not ref in ($not_to_uncheck_p)");
